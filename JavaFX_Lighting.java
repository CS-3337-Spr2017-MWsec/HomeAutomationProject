...
public class JavaFX_Lighting extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Circle circle = new Circle(100,  Color.rgb(255,255,255));
   ...
   //2     
      ...
      //Light.Distant: Represents a distant light source.
        ...
        Button btn2 = new Button("Button with Lighting");
        btn2.setEffect(lighting2);

        

        Circle circle2 = new Circle(100,  Color.rgb(255,255,255));
...
//3  
        ...
        Button btn3 = new Button("Button with Lighting");

        btn3.setEffect(lighting3);

        

        Circle circle3 = new Circle(100,  Color.rgb(255,255,255));
...
//3 ends
        root.getChildren().add(vBox); //yellow
        root.setAlignment(Pos.TOP_CENTER);
        root2.getChildren().add(vBox2);//red
        root2.setAlignment(Pos.TOP_LEFT);
        root3.getChildren().add(vBox3); //green
